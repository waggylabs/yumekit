...
export class YumeTag extends HTMLElement {
    ...
    get shape() { return this.getAttribute("shape") || "square"; }
    ...
    get styleType() { return this.getAttribute("style-type") || "filled"; }
    ...
    _getStyle() {
        ...
        const isCustomColor = !varEntry && (color.startsWith("#") || color.startsWith("rgb") || color.startsWith("hsl"));
        ...
        const sizeConfig = {
            small: { height: "var(--component-tag-height-small, 22px)", padding: "var(--component-tag-padding-small, var(--spacing-2x-small))", fontSize: "var(--font-size-small, 0.8em)" },
            medium: { height: "var(--component-tag-height-medium, 28px)", padding: "var(--component-tag-padding-medium, var(--spacing-x-small))", fontSize: "var(--font-size-label, 0.83em)" },
            large: { height: "var(--component-tag-height-large, 38px)", padding: "var(--component-tag-padding-large, var(--spacing-small))", fontSize: "var(--font-size-paragraph, 1em)" },
        };
