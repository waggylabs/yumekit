...
describe("YumeStepper", () => {
    ...
    it("renders with default attributes", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}'>
    ...
    it("renders y-icon when icon is provided", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_WITH_ICON}'>
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("renders description text", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_WITH_DESC}'>
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("renders empty when no items", async () => {
        const el = await fixture(html`<y-stepper>
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("applies status from items definition", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_WITH_STATUS}'>
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("shows check icon for complete steps", async () => {
        ...
        const firstIcon = el.shadowRoot.querySelector(".indicator.complete .indicator-icon y-icon");
        expect(firstIcon).to.exist;
    ...
    it("shows exclamation icon for error steps", async () => {
        ...
        const errorIcon = el.shadowRoot.querySelector(".indicator.error .indicator-icon y-icon");
    ...
    it("next() on last step does not fire finish when not all complete", async () => {
        ...
        let finished = false;
        el.addEventListener("finish", () => { finished = true; });
        el.next();
    ...
    it("previous() goes back one step", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' current="1">
            <div slot="account">Account</div>
            <div slot="details">Details</div>
            <div slot="review">Review</div>
        </y-stepper>`);
    ...
    it("goTo() is blocked by linear when target is not complete", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' linear>
            <div slot="account">Account</div>
            <div slot="details">Details</div>
            <div slot="review">Review</div>
        </y-stepper>`);
    ...
    it("goTo() is allowed in linear mode when target is complete", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' linear current="2">
            <div slot="account">Account</div>
            <div slot="details">Details</div>
            <div slot="review">Review</div>
        </y-stepper>`);
    ...
    it("reset() returns all steps to pending and current to 0", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' current="2">
            <div slot="account">Account</div>
        </y-stepper>`);
        ...
        const indicators = el.shadowRoot.querySelectorAll(".indicator.complete");
    ...
    it("editable allows clicking completed steps", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' editable current="2">
            <div slot="account">Account</div>
            <div slot="details">Details</div>
            <div slot="review">Review</div>
        </y-stepper>`);
    ...
    it("active indicator has aria-current=step", async () => {
        ...
        const activeBtn = el.shadowRoot.querySelector(".indicator.active .indicator-btn");
    ...
    it("panels have aria-labelledby linked to indicators", async () => {
        ...
        expect(panel.getAttribute("aria-labelledby")).to.equal("indicator-account");
    });
    ...
    it("completed step has (complete) in aria-label", async () => {
        ...
        const btn = el.shadowRoot.querySelector(".indicator.complete .indicator-btn");
    ...
    it("exposes stepper parts", async () => {
        ...
        expect(el.shadowRoot.querySelector("[part~='indicator-icon']")).to.exist;
        expect(el.shadowRoot.querySelector("[part~='indicator-label']")).to.exist;
    ...
    it("exposes indicator--active part on active step", async () => {
        ...
        expect(el.shadowRoot.querySelector("[part~='indicator--active']")).to.exist;
    });
    ...
    it("exposes indicator--complete part on complete step", async () => {
        ...
        expect(el.shadowRoot.querySelector("[part~='indicator--complete']")).to.exist;
    });
    ...
    it("exposes indicator--error part on error step", async () => {
        ...
        expect(el.shadowRoot.querySelector("[part~='indicator--error']")).to.exist;
    });
    ...
    it("renders panels before indicators when position=end", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' position="end">
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("applies right margin to panels when position=end (vertical)", async () => {
        const el = await fixture(html`<y-stepper items='${ITEMS_3}' position="end" orientation="vertical">
            <div slot="account">Account</div>
        </y-stepper>`);
    ...
    it("renders custom icon slot when slotted content exists", async () => {
        ...
        const iconSlot = el.shadowRoot.querySelector("slot[name='account-icon']");
